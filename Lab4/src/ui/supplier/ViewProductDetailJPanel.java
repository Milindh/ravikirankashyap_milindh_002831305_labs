...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    private void saveFeatures() 
    {
        ...
        {
            Feature currentFeatire = product.getFeatures().get(i);
            currentFeatire.setName(tblFeatures.getValueAt(i, 0).toString());
            currentFeatire.setValue(tblFeatures.getValueAt(i, 1));
